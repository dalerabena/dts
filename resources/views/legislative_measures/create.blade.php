                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <br>
                                        {!! Form::select('proponents[]', $proponents, null, ['class' => 'form-control', 'multiple' => 'multiple', 'id' => 'proponents']) !!}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('referred_when', null, ['class' => 'form-control', 'placeholder' => 'Entered referred when']) !!}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('reported_when',null, ['class' => 'form-control', 'placeholder' => 'Enter reported when']) !!}
                                    </div>
                                </div>
                            </div>
